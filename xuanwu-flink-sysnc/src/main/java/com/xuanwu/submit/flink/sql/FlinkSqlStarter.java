...
import com.xuanwu.submit.flink.Starter;
...
public class FlinkSqlStarter implements Starter {
    ...
    private static final String APP_JAR_NAME = "xuanwu-flink-sysnc.jar";
    private static final String CLASS_NAME = XuanwuSql.class.getName();
