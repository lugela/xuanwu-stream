...
public class SeaTunnelSinkPluginDiscovery extends AbstractPluginDiscovery<XuanwuSink> {
    ...
    @Override
    protected Class<XuanwuSink> getPluginBaseClass() {
        return XuanwuSink.class;
    }
}
